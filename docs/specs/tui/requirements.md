...
**TU-R-052** — Each card shall render as a bordered box with two columns of horizontal and one row of vertical margin between the border and the content, showing the title in the highlighted text color wrapped over as many lines as the content width requires, followed by one line of label badges.
