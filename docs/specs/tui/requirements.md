...
**TU-R-052** — Each card shall render as a bordered box showing the title wrapped over as many lines as the card's inner width requires, followed by one line of badges: one per label and one per assignee.
