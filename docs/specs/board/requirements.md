...
Spec-driven workflow: the local task board (`.claude/tasks`) cards and gates

Normative. IDs stable, append-only (BD-R-nnn) — never renumber, never reuse a retired ID. Boundary behavior/stated limitations → [`edge-cases.md`](./edge-cases.md) (BD-E-nnn, numbered independently).
...
**BD-R-001** — The <subject> shall <observable outcome> when <condition>.
-->
